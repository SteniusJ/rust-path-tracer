...
fn check_hits(ray: &ray::Ray, t_min: f64, t_max: f64, rec: &mut hitable::HitRecord, world: &Vec<Box<geometry::Triangle>>, default_mat: &'static dyn materials::Material) -> bool {
...
fn get_color(ray: &ray::Ray, world: &Vec<Box<geometry::Triangle>>, depth: u8, default_mat: &'static dyn materials::Material, rng: &mut SmallRng) -> vec3::Vec3 {
...
pub fn render(px_width: u16, px_height: u16, samples: u8, world: Vec<Box<geometry::Triangle>>, camera: camera::Camera, output_name: &str, default_mat: &'static dyn materials::Material, prog_interval: i64, denoising: u8) {
    ...
    while j >= 1 {
        ...
        while i < px_width {
            ...
            // gamma correctionhttps://colab.research.google.com/drive/1QYUUiRy8kjZ7Nz7EcHZCbd9QZj-w6GLQ?usp=sharing
